...
<<<<<<< HEAD
Based on our WebApp prototype and its feedback we started to develop an Android prototype using Android Studio. The structure remained basically the same as in the WebApp prototype, and we tried to use Google's Material Design language [https://material.io/guidelines/] in order to let the user work comfortably with our app from the very beginning.
=======
...
>>>>>>> 621f751b0d8a41c208ae3f09ec08a3219440688a
