...
\begin{figure}
	\centering
	\includegraphics[page=9,width=\textwidth]{balsamiq.pdf}
	\caption{Site map}
...
\begin{figure}
	\centering
	\includegraphics[page=10,width=\textwidth]{balsamiq.pdf}
	\caption{Clickstream}
