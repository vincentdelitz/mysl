...
\title[MySL]{MySL} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\medskip
\textit{Project presentation} % Your email address
}
